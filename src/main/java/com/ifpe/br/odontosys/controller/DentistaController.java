...
import com.ifpe.br.odontosys.DTO.request.CreateDentistaRequest;
...
public class DentistaController {
    ...
    @PostMapping
    public ResponseEntity<DentistaModel> createDentista(@RequestBody CreateDentistaRequest dentistaRequest){
